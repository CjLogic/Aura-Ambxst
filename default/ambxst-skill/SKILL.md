...
name: ambxst
description: >
  REQUIRED for ANY changes to Linux desktop, QML Shells, QuickShell/Qt environment, window manager, or system config.
  Use when editing ~/.config/Ambxst/
  or ~/Ambxst/. Triggers: themes, wallpaper, night light, idle, lock screen, screenshots, layer rules, workspace
  settings, display config.
---

# Ambxst Skill

Manage [ambxst](https://github.com/Axenide/Ambxst) QML Language - An Extremely customizable shell..

## When This Skill MUST Be Used

**ALWAYS invoke this skill when the user's request involves ANY of these:**

- Editing ANY file in `~/.config/Ambxst/` (window rules, animations, keybindings, monitors, etc.)
- Editing ANY file in `~/Ambxst`
