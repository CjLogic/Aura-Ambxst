...
export LOGO_PATH="$AURA_PATH/logo.txt"
...
export GUM_CONFIRM_PROMPT_FOREGROUND="3"     # Yellow for prompt
export GUM_CONFIRM_SELECTED_FOREGROUND="0"   # Black text on selected
export GUM_CONFIRM_SELECTED_BACKGROUND="3"   # Yellow background for selected
export GUM_CONFIRM_UNSELECTED_FOREGROUND="3" # Yellow for unselected
